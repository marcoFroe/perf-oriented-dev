...
To fulfill the requirement that the number of operations should be greater than the number of elements I choose to use the following multiplier:

- element count = 10: times 100
- element count = 1000: times 50
- otherwise: times 5